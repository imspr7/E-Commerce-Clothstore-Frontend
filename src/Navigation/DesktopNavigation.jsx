...
import { AiOutlineHeart, AiOutlineShoppingCart, AiFillCloseCircle,AiOutlineHome} from 'react-icons/ai'
        ...
        <div className="nav-items">
          <ul className="nav-items">
            <li className="nav-links">
              <NavLink to='/'>
                <span className='nav-icon-span'>  Home  <Badge badgeContent={setProceed ? cart.length : 0}> <AiOutlineHome className='nav-icon' /></Badge></span>
              </NavLink>
            </li>
            {/* <li className="nav-links">
              <NavLink to='/contact'>
